...
public final class GameState {
    ...
    public int getNumberOfPlayers() {return 0;}
    ...
    public int[][] getBoard() {return null;}

    // Returns the set of influence cards available to the given player.
    public Set<InfluenceCard> getAvailableInfluenceCards(int player) {return null;}

    // Checks if the specified move is allowed for the given player.
    public boolean isMoveAllowed(Move move, int player) {return true;}
}
